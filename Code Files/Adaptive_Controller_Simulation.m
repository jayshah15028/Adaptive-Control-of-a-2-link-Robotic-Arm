...
% intial condition
q0=[-0.28;1.358;0.01;-0.08;1.7;0.2;0.15];


[t,q]=ode45(@(t,q)adaptcontroller(t,q,alpha,beta),tspan,q0);

error = q - [th1_des' th2_des' th1dot_des' th2dot_des' p1 p2 p3];
lbd=5;
for i=1:length(t)
    p1 = q(i,5); p2 = q(i,6); p3 = q(i,7);
...
s = epdot + lbd*ep;
tau(:,i)= M_hat*qr_ddot + C_hat*qr_dot - K*s;
end
